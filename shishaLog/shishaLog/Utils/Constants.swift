...
let REF_USER_BLOCKING = DB_REF.child("user-blocking")
let REF_USER_BLOCKED = DB_REF.child("user-blocked")
...
let REF_REPORT_SPOTS = DB_REF.child("report-spots")
let REF_REPORT_USERS = DB_REF.child("report-users")
